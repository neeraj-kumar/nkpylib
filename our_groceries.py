...
def parse_list(lst: list[dict], include_deleted:bool=False) -> GroceryList:
...
def get_list(include_deleted=False) -> GroceryList:
...
def item_id_by_name(item: str) -> str|None:
